...
function draw (){
    ...
    if(gameState===3){
        ...
        if(bulletGrpEnemy.isTouching(spaceShuttle)){
            ...
            bulletGrpEnemy.destroyEach();
            switch (hearts){
                case 12: heart5.visible = false;
                break ;
                case 9: heart4.visible = false;
                break;
                case 6: heart3.visible = false;
                break ;
                case 3: heart2.visible = false;
                break ;
...
function spaceship1(){
        ...
        alienship1=createSprite(random(50,900),random(20,spaceShuttle.y -200));
        ...
        if(alienship1.x<spaceShuttle.x){
            bullet_enemy.velocityX = random(5,20)
           }else{
            bullet_enemy.velocityX = random(-5,-20)
           }
        bullet_enemy.velocityY = 30;
...
function spaceship2(){
    ...
    alienship2=createSprite(random(50,900),random(20,spaceShuttle.y -200));
    ...
    if(alienship2.x<spaceShuttle.x){
        bullet_enemy.velocityX = random(5,20)
       }else{
        bullet_enemy.velocityX = random(-5,-20)
       }
    bullet_enemy.velocityY = 35;
    bullet_enemy.addImage(enemyBulletImg);
    bullet_enemy.scale=0.15
    bullet_enemy.lifetime=200;
    bulletGrpEnemy.add(bullet_enemy);
...
function spaceship3(){
    ...
    alienship3=createSprite(random(50,900),random(20,spaceShuttle.y -200));
   ...
   if(alienship3.x<spaceShuttle.x){
    bullet_enemy.velocityX = random(5,20)
   }else{
    bullet_enemy.velocityX = random(-5,-20)
   }
